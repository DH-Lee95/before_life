    ...
    case "last_day":
      return {
        ...
        chapters: [
          ...
          { title: "해가 지기 전의 선택", paragraphs: [`당신은 자신의 고백과 증거를 세상에 남기면 한동안 혼란이 생긴다는 것을 알았습니다. 그래도 이번에는 안정을 지킨다는 이유로 다른 사람에게 침묵의 대가를 떠넘기지 않기로 했습니다. 그 사람에게 모든 기록을 건네고 어떻게 사용할지는 직접 선택하게 했습니다.`, `그는 끝내 용서한다는 말은 하지 않았지만 해가 질 때까지 곁에 남았습니다. 기록은 죽음의 순간이 아니라, 평생 다른 사람을 위해 결정하던 사람이 처음으로 자신의 잘못을 직접 책임진 장면에서 멈춥니다.`] },
        ],
