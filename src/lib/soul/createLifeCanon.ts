...
const motives: Record<SoulArchetypeId, { desire: string; fear: string; relationship: string; legacy: string }> = {
  ...
  scholar: { desire: "권위보다 관찰과 사실을 믿을 수 있는 기록을 남기는 것", fear: "틀린 설명이 진실처럼 굳어 다음 사람을 해치는 것", relationship: "당신의 질문을 귀찮아하지 않았던 학생 또는 농부", legacy: "이름 없는 사람의 발견도 지식으로 남을 수 있게 했습니다." },
  ...
  performer: { desire: "사람들이 외면하던 마음을 무대 위에서 말하게 하는 것", fear: "박수를 얻기 위해 진짜 하고 싶던 말을 지우는 것", relationship: "공연 뒤 당신의 진짜 목소리를 알아본 관객 또는 동료", legacy: "웃음과 음악 안에도 감춰진 이야기를 말할 자리를 남겼습니다." },
