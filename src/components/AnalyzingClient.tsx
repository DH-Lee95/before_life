...
export function AnalyzingClient() {
  ...
  const next = getSafeResultPath(searchParams.get("next"));
...
export function getSafeResultPath(value: string | null): string {
  if (!value || !value.startsWith("/result/") || value.startsWith("//") || value.includes("\\")) return "/";
