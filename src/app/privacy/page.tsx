  ...
  return (
    <LegalPage title="개인정보처리방침">
      <LegalSection title="1. 처리하는 정보와 목적">
        ...
        <p>카카오 로그인 시 계정 식별정보를, 결제 시 주문번호·결제키·금액·결제 상태를 처리합니다. 서비스 개선과 보안 목적의 접속·이용 기록, 광고 유입 정보가 생성될 수 있습니다.</p>
      </LegalSection>
      ...
      <LegalSection title="3. 처리위탁과 외부 서비스">
        <p>서비스 운영을 위해 Supabase(데이터베이스·인증), Vercel(호스팅), Toss Payments(결제), Kakao(로그인), OpenAI(유료 이야기 문장 생성)를 이용합니다. OpenAI에는 생년월일 원문이나 카카오 계정정보를 보내지 않고, 이야기 작성에 필요한 압축된 전생 설정만 전달합니다.</p>
